...
export const PERSONAL_PROJECTS = [
  {
    ...
    description:
      "Turborepo monorepo with 3 apps (student web, admin, Elysia REST API on Bun) and 6 shared packages for auth, db, payments, storage, UI, and server types with end-to-end type safety via Eden treaty contracts. Built Razorpay monetization with verified webhooks, PostgreSQL access gating, S3 delivery, and scaled with SSG/ISR plus Redis caching.",
    tech: [
      { icon: IconBrandNextjs, name: "Next.js" },
